...
public class ShowLocationvActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtLat = findViewById(R.id.locationv);
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION)!=PackageManager.PERMISSION_GRANTED) {
            ...
            if(location!=null) {
                txtLat.setText("Now you can access the ussd services through number *384*3834#. You will get help asked by victims through the code 86387 and you can send alerts to victims by using ALERT message to 86387");
            }
    ...
    public void postLocation(final Location location) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
            ...
            try {
                ...
                String URL = "http://brahmastra.azurewebsites.net/locationv/";
